...
from core.paths import get_project_path, get_precice_config_path
...
def register_config_tools(mcp: FastMCP) -> None:
    ...
    def summarize_precice_config(project_name: str) -> str:
        ...
        This extracts XML tags and gives a lightweight structural summary.
        """
        config_file = get_precice_config_path(project_name)
...
"""
    ...
    def check_precice_config(project_name: str) -> str:
        ...
        Requires precice-cli or precice-tools to be installed locally.
        """
...
"""
    ...
    def visualize_precice_config(project_name: str) -> str:
        ...
        Usually creates an output file such as precice-config.png or similar.
        """
        project_path = get_project_path(project_name)
        config_file = get_precice_config_path(project_name)
